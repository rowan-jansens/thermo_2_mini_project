function [h_out, s_out, T_out, P_out, W_dot, S_gen, rho_out] = compressor(h_in, s_in, T_in, P_in, pressure_ratio, n_compressor)
   global fluid mass_flow_rate
    ...
    rho_out = refpropm('D', 'P', P_out, 'h', h_out, fluid);
