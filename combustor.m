function [h_out, s_out, T_out, P_out, Q_dot_comb, fuel_m_dot, rho_out] = combustor(h_in, s_in, T_in, P_in, T_max)
...
rho_out = refpropm('D','T',T_out,'P',P_out,fluid); % Calculates the enthalpy at combustion chamber output
